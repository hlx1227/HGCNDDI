...
from Heterograph import graph_predict
# from DglPredictHeter_overAUndersample import graph_predict
from binary_model import Model, HeteroMLPPredictor
...
def Train(random_seed, epochs, lr, eps, weight_decay):
    ...
    for i in range(5):
        ...
        model = Model(1603, 128, 300, 100, 4, graph_predict.etypes).to(device)
    ...
    torch.save(save_model, 'model.pt')
